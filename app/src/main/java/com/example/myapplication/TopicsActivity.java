...
import com.example.myapplication.utils.DepthPageTransformer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   EdgeToEdge.enable(this);
      ...
      //  Toast.makeText(TopicsActivity.this,categoryNo, Toast.LENGTH_SHORT).show();
        ...
        binding.changeActiveTopicFab.setOnClickListener(v -> changeTopic());
        ...
        ViewCompat.setOnApplyWindowInsetsListener(binding.changeActiveTopicFab, (v, windowInsets) -> {
