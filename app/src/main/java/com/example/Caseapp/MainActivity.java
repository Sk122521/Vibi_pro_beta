...
import com.example.Caseapp.databinding.CustomViewLayoutBinding;
import com.example.Caseapp.service.DatabaseMonitoringService;
...
//        Intent intent = new Intent(MainActivity.this, DatabaseMonitoringService.class);
//        startService(intent);
...
//        main.addView(circleContainer);
        ...
        String[] categories = {"Asia","Africa","Australia","Europe","America"};
        ...
        for (int i = 0; i < numViews; i++) {
            ...
            FirebaseDatabase.getInstance().getReference().child("categories").child(categories[x]).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
...
//            cardView.setBackground(rippleDrawable);
                    ...
                    customViewBinding.imageCategories.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            intent.putExtra("categoryNo",categories[x]);
                    ...
                    customViewBinding.imageCategories.setOnLongClickListener(new View.OnLongClickListener() {
                        ...
                        public boolean onLongClick(View v) {
                            ...
                            intent.putExtra("categoriesNo", categories[x]);
                            startActivity(intent);
                            return true;
                        }
                    });
